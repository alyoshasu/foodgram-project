...
def technologies(request):
    return render(
        ...
        {
            "title": "Технологии",
            "text": "Это онлайн-сервис, где пользователи смогут публиковать "
                    ...
                    "скачивать сводный список продуктов, необходимых для "
...
def project(request):
    return render(
        ...
        {
            "title": "О проекте",
            "text": "Django, gunicorn, PostgreSQL, nginx, Docker, "
                    "Django REST Framework, Github Actions, Яндекс.Облако"
        }
    )
